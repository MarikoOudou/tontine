...
class _CreerTontineState extends State<CreerTontine> {
  ...
  Widget build(BuildContext context) {
    ...
    return
        ...
        BlocConsumer<TontineCubit, TontineState>(
      listener: (tontineContext, state) {
        // TODO: implement listener
        if (state is TontineError) {
          print(state);
        }
      },
      builder: (tontineContext, state) {
                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: ((context, index) {
                                  Map<String, dynamic> periode =
                                      periodes[index];
                                  return Card(
                                    color: valeurPeriode == periode["id"]
                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: ((context, index) {
                                  Map<String, dynamic> montant =
                                      montants[index];
                                  return Card(
                                    color: valeurMontant == montant["id"]
                                        ? ColorTheme.primaryColorYellow.shade400
                                        : ColorTheme.primaryColorBlue.shade400,
                                    child: InkWell(
                                      onTap: (() {
                          ...
                          child: ElevatedButton(
                              onPressed: (() async {
                                if (_formKey.currentState!.validate()) {
                                  ...
                                  // });
                                  // print(dataToSend);
                                  BlocProvider.of<TontineCubit>(context)
                                      .createTontine(
                                          RegisterModelTontine.fromMap(
                                              dataToSend));
